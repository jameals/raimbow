...
The overlay takes ~1.5hrs on Sam's computer; it takes so much longer than the humpback overlay because the blue whale predictions go so much farther offshore. If desired, you can copy the code sections from this document, up through tmp.over, into an R script to run as a job in the background.
...
tmp.over <- overlay_sdm(grid.5km.lno, bm.sf, preds.names, overlap.perc = 0)
