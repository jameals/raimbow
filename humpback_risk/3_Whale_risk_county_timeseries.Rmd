...
if (user == "JS") {
  ...
  file.grid.region <- "../raimbow-local/RDATA_files/Grid_region_county.Rdata"
...
if (flag.save) save(all.df, all.df.summ, file = paste0(path.rdata, "Whale_risk_county_timeseries.Rdata"))
