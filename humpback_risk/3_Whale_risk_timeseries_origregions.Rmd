...
This file uses 'Grid_region.Rdata' for the regions by which to plot the data.
...
if (user == "JS") {
  ...
  file.grid.region <- "C:/SMW/RAIMBOW/raimbow-local/RDATA_files/Grid_region.Rdata"
  
  file.out.timeseries <- "C:/SMW/RAIMBOW/raimbow-local/RDATA_files/Whale_risk_timeseries_origregions.Rdata"
  # path.plots <- if (wa.inc) {
  #   "C:/SMW/RAIMBOW/raimbow-local/Plots/Whale_risk_timeseries/"
  # } else {
  #   "C:/SMW/RAIMBOW/raimbow-local/Plots/Whale_risk_timeseries_noWA/"
  # }
