...
The code in this document calculates (humpback) whale risk of entanglement for each grid cell as: humpback density * fishing measure (e.g. # of VMS pings or $ of Dungeness crab landed)
...
save(
  df.key.ym, risk.all, fish.all, humpback.all,
