...
#----------------------------------------------------------------------------
#----------------------------------------------------------------------------
# find 75th percentile value for hw across 2013-2020, in clipped (44N) extent
...
png(paste0(path_figures, "/good_wh_habitat_MaySep_75th_across_20132020_applied to each season_2019-2020_spatially_clipped.png"), width = 14, height = 10, units = "in", res = 300)
...
summary_75th_HW_habitat_fishing <- x.whale.2013_2020_MaySep_good_habitats_fishing %>% 
  filter(HW_is_75th_or_higher == 'Y') %>% 
  group_by(season) %>% 
  summarise(trapdens_mean = mean(mean_trapdens, na.rm=TRUE),
            trapdens_median = median(mean_trapdens, na.rm=TRUE)
...
png(paste0(path_figures, "/ts_fishing_in_75th_hw_habitat_MaySep.png"), width = 17, height = 10, units = "in", res = 300)
