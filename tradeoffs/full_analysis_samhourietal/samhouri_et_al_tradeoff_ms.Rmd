---
title: "Samhouri et al tradeoff analysis"
...
This is where we can move through the workfolow, from prepping whale and fishing data to running the effort_mgmt and risk_mgmt functions that implement scenarios of interest.
