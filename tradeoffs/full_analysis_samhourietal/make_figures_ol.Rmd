...
to_blue_n_pre_post <- ggplot(
  ...
  coord_fixed(ratio=100/130)+ # fixed ratio plot (calculated here as x-range/y-range)
...
png(
  ...
  paste0("Tradeoff plot - normalized blues only by pre_post_nolegend_",today(),".png")), 
    width = 3.75, height = 6, units = "in", res = 300)
ggdraw(to_blue_n_pre_post_nolegend)+
  ...
  draw_label("bad",x=0.5,y=0.15)+
  draw_label("good",x=0.7,y=0.25)
invisible(dev.off())
```
...
png(
  ...
  "full_analysis_samhourietal",
  "figures",
  paste0("Tradeoff plot - blues and humps",today(),".png")), 
...
NOTE: THE CODE BELOW HAS NOT YET BEEN MODIFIED TO FOCUS ON SM VESSELS ONLY. NEED TO ADD FILE PATHS IN 1ST CHUNK ABOVE. PICK UP HERE. 010721
