...
For this section, the user will need to update the next code block to reflect the desired filters

```{r}
# TODO by user: set filter as desired
#   User will also need to update y value, plot titles, and file names below
filename.out <- "Monthly_Nov2009_Oct2014.png"
...
Now we make plots of these seasonality sections
