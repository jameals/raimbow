...
temporal_scenarios <- c(
  "Marine_Life_Delay",
  "Early closure",
  "Marine_Life_Delay_And_Early_Closure"
) 
...
# add columns for scenario_df_name, spatial_domain, scenario_lag
scenario_table <- scenario_table %>%
  mutate(
    scenario_df_name = paste(spatial,temporal,sep="_"),
    spatial_domain = ifelse(spatial == "cenCA_only", "Region",
                            ifelse(spatial == "all_BIAs", "BIA_bm_or_mn","")
                            ),
    scenario_lag = ifelse(temporal == "One_Month_Delay" | temporal == "One_Month_Delay_And_Early_Closure", 1,
                            ifelse(temporal == "Two_Month_Delay" | temporal == "Two_Month_Delay_And_Early_Closure", 2,0)
                            )
  )
