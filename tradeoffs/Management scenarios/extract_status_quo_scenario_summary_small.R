...
# read in sq data
x.orig.noinfo <- read_rds("~/Documents/RAIMBOW/Processed Data/VMS/CA_DCRB_vms_fishing_daily_2009-2019_small_vessels_regions_depths.RDS")
...
range(risk_out_sq$Num_DCRB_VMS_pings) # 366 is max

# write out for use in tradeoff figures Rmd
write_rds(risk_out_sq, paste0("/Users/jameal.samhouri/Documents/RAIMBOW/Processed Data/Samhouri et al. whales risk/Output_Data/scenario_output_dataframes/status_quo_risk_small_vessels_2009_2019_yr_mth_",today(),".rds"))

risk_out_sq_list_by_yr_mth <- risk_out_sq %>% split(.$year_month)

# write out for trial run using prioritizr
write_rds(risk_out_sq_list_by_yr_mth, paste0("/Users/jameal.samhouri/Documents/RAIMBOW/Processed Data/Samhouri et al. whales risk/Output_Data/scenario_output_dataframes/status_quo_risk_small_vessels_2009_2019_list_by_yr_mth_",today(),".rds"))
