...
map_pings <- ggplot() + 
  ...
  facet_wrap(~time_period, nrow=1) +
  geom_sf(data=rmap.base,col=NA,fill='gray50') +
  scale_fill_viridis(na.value=NA,option="D",name="VMS Pings") + # ,breaks=seq(0,1,by=0.25),limits=c(0,1)
  scale_color_viridis(na.value=NA,option="D",name="VMS Pings") + # ,breaks=seq(0,1,by=0.25),limits=c(0,1)
