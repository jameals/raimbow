...
glimpse(annual_statewide_df_focal_scenarios_means)

annual_statewide_df_focal_scenarios_means_bp <- annual_statewide_df_focal_scenarios %>% 
  left_join(annual_statewide_df_focal_scenarios_means) %>%
  mutate(
