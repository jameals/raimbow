...
date: "initiated 5/22/2020, modified 6/17/2020"
output:
...
#Initial processing
entanglement_df <- foreign::read.dbf(path_entanglement_file)
...
group_by(Year, Common_Nam) %>%
  ...
  mutate(
    species = case_when(Common_Nam == "Gray Whale" ~ "Gray Whale",
                        Common_Nam == "Humpback Whale" ~ "Humpback Whale",
                        Common_Nam == "Blue Whale" | Common_Nam == "Blue whale" ~ "Blue Whale",
...
# zeroes <- data.frame(
#   seq(2000,2019,1),
#   rep(0,length(seq(2000,2019,1)))
# )
# names(zeroes) <- c("Year","n")
# 
# entanglement_df_annual_complete <-rbind(zeroes, entanglement_df_annual)
# glimpse(entanglement_df_annual_complete)
...
### Get annual entanglements for blues and humpbacks separately
...
entanglements_ts <- ggplot(entanglement_df_annual_complete %>% filter (Year >= 2000), 
                           aes(x=Year, y=n, group=species, colour=species)) + # group=1 tells ggplot that there is only 1 group
  geom_point(size=2) +
  geom_line() + 
  ylab("Number of\nentanglements") +
  xlab("Year") +
...
myplot <- ggplot(entanglement_df_blue_annual_complete, aes(x=Year, y=n, group=1)) + # group=1 tells ggplot that there is only 1 group
  ...
  xlab("Year") +
  #xlim(1980,2020) +
  labs(subtitle = "Data from NMFS WRO, Lauren Saez") +
...
# unique(sq_DCRBcells_maps_df$GRID5KM_ID[which(is.na(sq_DCRBcells_maps_df$Humpback_abund_mean))])
# unique(x.whale$GRID5KM_ID[which(is.na(x.whale$Humpback_abund_mean))])
# unique(sq_DCRBcells_maps_df$GRID5KM_ID[which(is.na(sq_DCRBcells_maps_df$Blue_occurrence_mean))])
...
write_csv(sq_maps_grid_noNA, paste0(path_maps,"/Data frame for Figure 2 Samhouri et al.csv"))
...
sq_maps_grid_noNA %>% 
  filter(time_period == "2014-2018") %>%
  select(diff_Humpback_dens) %>%
  ggplot(aes(x=diff_Humpback_dens)) +
  geom_density(fill='#33638DFF', alpha=0.8)

map_diff_humps <- ggplot() + 
  geom_sf(data=sq_maps_grid_noNA %>% filter(time_period != "2009-2014"), 
          aes(fill=diff_Humpback_dens,
              col=diff_Humpback_dens
          )
  ) +
  facet_wrap(~time_period, nrow=1) +
  geom_sf(data=rmap.base,col=NA,fill='gray50') +
  scale_fill_viridis(na.value=NA,option="D",name="Change in\nHumpback Density") + # ,breaks=seq(0,1,by=0.25),limits=c(0,1)
  scale_color_viridis(na.value=NA,option="D",name="Change in\nHumpback Density") + # ,breaks=seq(0,1,by=0.25),limits=c(0,1)
  ggtitle("Change in median humpback densities on Dungeness crab fishing grounds\nduring the fishing season") +
  coord_sf(xlim=c(sq_bbox[1],sq_bbox[3]),ylim=c(sq_bbox[2],sq_bbox[4])) + 
  theme_minimal() + #theme_classic() +
  theme(text=element_text(family="sans",size=10,color="black"),
        legend.text = element_text(size=10),
...
png(paste0(path_maps, "/map_diff_humps_by_time_period.png"), width = 14, height = 10, units = "in", res = 300)
map_diff_humps
invisible(dev.off())
...
sq_maps_grid_noNA %>% 
  filter(time_period == "2014-2018") %>%
  select(diff_Blue_occurrence) %>%
  ggplot(aes(x=diff_Blue_occurrence)) +
  geom_density(fill='#33638DFF', alpha=0.8)

map_diff_blues <- ggplot() + 
  geom_sf(data=sq_maps_grid_noNA %>% filter(time_period != "2009-2014"), 
          aes(fill=diff_Blue_occurrence,
              col=diff_Blue_occurrence
          )
  ) +
  facet_wrap(~time_period, nrow=1) +
  geom_sf(data=rmap.base,col=NA,fill='gray50') +
  ...
  scale_color_viridis(na.value=NA,option="D",name="Change in\nBlue Whale\nOccurrence") + # ,breaks=seq(0,1,by=0.25),limits=c(0,1)
  ggtitle("Change in median blue whale occurrenceon Dungeness crab\nfishing grounds during the fishing season") +
  coord_sf(xlim=c(sq_bbox[1],sq_bbox[3]),ylim=c(sq_bbox[2],sq_bbox[4])) + 
  theme_minimal() + #theme_classic() +
  theme(text=element_text(family="sans",size=10,color="black"),
        legend.text = element_text(size=10),
...
png(paste0(path_maps, "/map_diff_blues_by_time_period.png"), width = 14, height = 10, units = "in", res = 300)
map_diff_blues
invisible(dev.off())
...
sq_maps_grid_noNA %>% 
  filter(time_period == "2014-2018") %>%
  select(diff_Num_DCRB_VMS_pings) %>%
  ggplot(aes(x=diff_Num_DCRB_VMS_pings)) +
  geom_histogram(fill='#33638DFF', alpha=0.8, binwidth=0.5)

map_diff_pings <- ggplot() + 
  geom_sf(data=sq_maps_grid_noNA %>% filter(time_period != "2009-2014"), 
          aes(fill=diff_Num_DCRB_VMS_pings,
              col=diff_Num_DCRB_VMS_pings
          )
  ) +
  facet_wrap(~time_period, nrow=1) +
  geom_sf(data=rmap.base,col=NA,fill='gray50') +
  scale_fill_viridis(na.value=NA,option="D",name="Change in\nVMS Pings") + # ,breaks=seq(0,1,by=0.25),limits=c(0,1)
  scale_color_viridis(na.value=NA,option="D",name="Change in\nVMS Pings") + # ,breaks=seq(0,1,by=0.25),limits=c(0,1)
  ggtitle("Change in median VMS pings\nduring the Dungeness crab\nfishing season") +
  coord_sf(xlim=c(sq_bbox[1],sq_bbox[3]),ylim=c(sq_bbox[2],sq_bbox[4])) + 
  theme_minimal() + #theme_classic() +
  theme(text=element_text(family="sans",size=10,color="black"),
        legend.text = element_text(size=10),
...
png(paste0(path_maps, "/map_diff_pings_by_time_period.png"), width = 14, height = 10, units = "in", res = 300)
map_diff_pings
invisible(dev.off())

# ggplot() + 
#   geom_sf(data=hump.all_grid, 
#           aes(fill=Humpback_dens_mean,
#               col=Humpback_dens_mean
#           )
#   ) +
#   geom_sf(data=rmap.base,col=NA,fill='gray50') +
#   ggtitle("2009-2019 Mean humpback densities") +
#   coord_sf(xlim=c(sq_bbox[1],sq_bbox[3]),ylim=c(sq_bbox[2],sq_bbox[4]))
# 
# ggplot() + 
#   geom_sf(data=x.whale_grid, 
#           aes(fill=Humpback_abund_mean,
#               col=Humpback_abund_mean
#           )
#   ) +
#   geom_sf(data=rmap.base,col=NA,fill='gray50') +
#   ggtitle("2009-2019 Mean humpback densities") +
...
### This is Figure 2 in Samhouri et al
ggarrange(map_blue,
          map_hump,
          map_pings,
          ncol=3,
...
png(paste0(path_figures, "/p_maps.png"), width = 14, height = 10, units = "in", res = 300)
ggarrange(map_blue,
          map_hump,
          map_pings,
          ncol=3,
...
## Time series of cumulative annual (a) humpback risk, (b) blue risk, (c) DCRB revenue. Emphasizes contrasts between Statewide, region, BIAs. All vessels.
...
png(paste0(path_figures, "/plot_ts_sq.png"), width = 14, height = 10, units = "in", res = 300)
ts_sq
invisible(dev.off())
...
ts_sq_whales <- ggplot(
  data = annual_risk_out_sq %>% filter(response_metric != "DCRB_rev"), 
  aes(
    x = plotting_year, 
    y= response
  )
  ...
  facet_grid(rows = vars(response_metric),
             ...
             labeller = as_labeller ( c(
               # `DCRB_rev` = "Dungeness crab\nfishery revenue\n(cumulative $, x10^5)",
               `n_risk_blue` = "Cumulative risk to\nblue whales\n(normalized)",
               `n_risk_humpback` = "Cumulative risk to\nhumpback whales\n(normalized)"
               ) ),
             switch = "y"
             ) + 
  scale_x_continuous(breaks = seq(2010, 2019),
...
png(paste0(path_figures, "/plot_ts_sq_whales.png"), width = 14, height = 10, units = "in", res = 300)
ts_sq_whales
invisible(dev.off())
...
png(paste0(path_figures, "/ts_sq_DCRBrev.png"), width = 14, height = 10, units = "in", res = 300)
ts_sq_DCRBrev
invisible(dev.off())
...
png(paste0(path_figures, "/all_ts.png"), width = 10, height = 14, units = "in", res = 300)
ggarrange(entanglements_ts,
          ts_sq_whales,
          ts_sq_DCRBrev,
          ncol=1,
...
## Time series of cumulative annual (a) humpback risk, (b) blue risk, (c) DCRB revenue. Emphasizes contrasts between Statewide, region, BIAs. Small vessels.

```{r}

risk_out_sq_small_vessels <- read_rds(path_status_quo_small_vessels)
names(risk_out_sq_small_vessels)
glimpse(risk_out_sq_small_vessels)
...
risk_out_sq_small_vessels %<>% mutate(
  month = as.numeric(substr(year_month,6,7)),
  crab_year = func_crab_year(year_month),
  plotting_year = as.numeric(substr(crab_year,6,9)),
  )
...
# summarise cumulative sum of $ and risk by crab_year
annual_risk_out_sq_small_vessels <- risk_out_sq_small_vessels %>%
  group_by(crab_year) %>%
  summarise(
...
glimpse(annual_risk_out_sq_small_vessels)
...
ts_sq_small_vessels <- ggplot(
  data = annual_risk_out_sq_small_vessels, 
  aes(
    x = plotting_year, 
    y= response
  )
  ...
  scale_x_continuous(breaks = seq(2010, 2019),
                     labels = unique(annual_risk_out_sq_small_vessels$crab_year)) + 
  ylab("") + 
  xlab("Dungeness crab season") +
  theme_classic() +
  theme(legend.title = element_blank(),
...
png(paste0(path_figures, "/plot_ts_sq_small_vessels.png"), width = 14, height = 10, units = "in", res = 300)
ts_sq_small_vessels
invisible(dev.off())

# summarise cumulative sum of $ and risk by crab_year, region
annual_risk_out_sq_small_vessels_region <- risk_out_sq_small_vessels %>%
  group_by(crab_year, Region) %>%
  summarise(
...
glimpse(annual_risk_out_sq_small_vessels_region)
...
ts_sq_region_small_vessels <- ggplot(
  data = annual_risk_out_sq_small_vessels_region, 
  aes(
    x = plotting_year, 
    y= response
  )
...
png(paste0(path_figures, "/plot_ts_sq_region_small_vessels.png"), width = 10, height = 8, units = "in", res = 300)
ts_sq_region_small_vessels
invisible(dev.off())

# summarise cumulative sum of $ and risk by crab_year, BIA
annual_risk_out_sq_small_vessels_bia <- risk_out_sq_small_vessels %>%
  group_by(crab_year, BIA_bm_or_mn) %>%
  summarise(
...
glimpse(annual_risk_out_sq_small_vessels_bia)
  

# plot normalized humpbacks, normalized blues, $

ts_sq_bia_small_vessels <- ggplot(
  data = annual_risk_out_sq_small_vessels_bia, 
  aes(
    x = plotting_year, 
    y= response
  )
...
png(paste0(path_figures, "/plot_ts_sq_bia_small_vessels.png"), width = 10, height = 8, units = "in", res = 300)
ts_sq_bia_small_vessels
invisible(dev.off())
...
## Time series of cumulative risk and revenue by early/mid/late season (a) humpback risk, (b) blue risk, (c) DCRB revenue. Emphasizes contrasts between times of year for each metric. All vessels
...
## Time series of cumulative risk and revenue by early/mid/late season (a) humpback risk, (b) blue risk, (c) DCRB revenue. Emphasizes contrasts between times of year for each metric. Small vessels
...
# summarise cumulative sum of $ and risk by crab_year, time_period within each crab_year
annual_risk_out_sq_small_vessels_time_period <- risk_out_sq_small_vessels %>%
  group_by(crab_year, time_of_crab_year) %>%
  summarise(
...
glimpse(annual_risk_out_sq_small_vessels_time_period)
  

# plot normalized humpbacks, normalized blues, $

ts_sq_time_of_crab_year_small_vessels <- ggplot(
  data = annual_risk_out_sq_small_vessels_time_period, 
  aes(
    x = plotting_year, 
    y= response
  )
...
png(paste0(path_figures, "/plot_ts_sq_time_of_crab_year_small_vessels.png"), width = 14, height = 10, units = "in", res = 300)
ts_sq_time_of_crab_year_small_vessels
invisible(dev.off())
...
## Time series of cumulative risk and revenue in cenCA vs norCA, faceted by early/mid/late season and humpbacks, blues, DCRB. Emphasizes contrasts between regions and times of year for each metric. All vessels
...
## Time series of cumulative risk and revenue in cenCA vs norCA, faceted by early/mid/late season and humpbacks, blues, DCRB. Emphasizes contrasts between regions and times of year for each metric. Small vessels

```{r}

# summarise cumulative sum of $ and risk by crab_year, region, time_of_crab_year
annual_risk_out_sq_region_time_period_small_vessels <- risk_out_sq_small_vessels %>%
  group_by(crab_year, Region, time_of_crab_year) %>%
  summarise(
...
glimpse(annual_risk_out_sq_region_time_period_small_vessels)
  

# plot normalized humpbacks, normalized blues, $

ts_sq_region_time_period_small_vessels <- ggplot(
  data = annual_risk_out_sq_region_time_period_small_vessels, 
  aes(
    x = plotting_year, 
    y= response
  )
...
png(paste0(path_figures, "/plot_ts_sq_region_time_period_small_vessels.png"), width = 14, height = 10, units = "in", res = 300)
ts_sq_region_time_period_small_vessels
invisible(dev.off())
...
## Time series of cumulative risk and revenue in and out of BIAs, faceted by early/mid/late season and humpbacks, blues, DCRB. Emphasizes contrasts in and out of BIAs and times of year for each metric. All vessels
...
## Time series of cumulative risk and revenue in and out of BIAs, faceted by early/mid/late season and humpbacks, blues, DCRB. Emphasizes contrasts in and out of BIAs and times of year for each metric. Small vessels

```{r}

# summarise cumulative sum of $ and risk by crab_year, region, time_of_crab_year
annual_risk_out_sq_bia_time_period_small_vessels <- risk_out_sq_small_vessels %>%
  group_by(crab_year, BIA_bm_or_mn, time_of_crab_year) %>%
  summarise(
...
glimpse(annual_risk_out_sq_bia_time_period_small_vessels)
  

# plot normalized humpbacks, normalized blues, $

ts_sq_bia_time_period_small_vessels <- ggplot(
  data = annual_risk_out_sq_bia_time_period_small_vessels, 
  aes(
    x = plotting_year, 
    y= response
  )
...
png(paste0(path_figures, "/plot_ts_sq_bia_time_period_small_vessels.png"), width = 14, height = 10, units = "in", res = 300)
ts_sq_bia_time_period_small_vessels
invisible(dev.off())
...
## Avg risk in 2009-14 v 2014-18 v 2018-2019 for blues and humps by scenario. All vessels

Get the data frames in order
```{r}

annual_statewide_df_focal_scenarios <- read_rds(path_annual_statewide_df_focal_scenarios)
glimpse(annual_statewide_df_focal_scenarios)

# add pre/post 2014, plotting_year
annual_statewide_df_focal_scenarios %<>% mutate(
  plotting_year = as.numeric(substr(crab_year,6,9)),
...
# join to annual df
annual_statewide_df_focal_scenarios %<>%
  left_join(df_tradeoff_focal_scenarios)

# arrange scenarios by risk to humpbacks.

# code below is just toy code to figure out how to arrange properly
# tmp <- tibble(
#   period = factor(c("pre","pre","pre","during","during","during", "after", "after", "after"),levels=c("pre", "during", "after")),
#   risk = c(1,3,4,3,40,60,50,5,4),
#   scenario = c("A","B","C","A","B","C","A","B","C")
# )
# 
# tmp2 <- tmp %>% arrange(risk) %>% mutate(scenario_rank = row_number()) %>% group_by(scenario) %>% filter(period == "during") %>% mutate(scenario_rank_during = scenario_rank) %>% full_join(tmp)
# 
# ggplot(
#   data = tmp2,
#   aes(
#     x = reorder(scenario,scenario_rank_during),
#     y = risk,
#     colour = period
#     )
#   )  +
#   geom_point(size=5, alpha = 0.8, position=position_jitterdodge()) +
#   theme_bw()
...
statewide_annual <- annual_statewide_df_focal_scenarios %>%
...
cenca_annual <- annual_statewide_df_focal_scenarios %>%
...
bia_annual <- annual_statewide_df_focal_scenarios %>%
...
median_scenario_period <- annual_statewide_df_focal_scenarios %>%
  group_by(pretty_scenario_names, pre_post) %>%
  summarise(
...
annual_rank_bp <- annual_statewide_df_focal_scenarios %>%
...
plot_hump_risk_prepost_statewide <- ggplot(
...
png(paste0(path_figures, "/plot_hump_risk_prepost_statewide.png"), width = 14, height = 10, units = "in", res = 300)
plot_hump_risk_prepost_statewide
invisible(dev.off())
...
png(paste0(path_figures, "/plot_hump_risk_prepost_statewide_bp.png"), width = 14, height = 10, units = "in", res = 300)
plot_hump_risk_prepost_statewide_bp
invisible(dev.off())

# normalized humpbacks, statewide scenarios only, as geom_line
plot_hump_risk_prepost_statewide_connect <- ggplot(
  data = statewide_annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = n_risk_humpback,
...
png(paste0(path_figures, "/plot_hump_risk_prepost_statewide_connect.png"), width = 14, height = 10, units = "in", res = 300)
plot_hump_risk_prepost_statewide_connect
invisible(dev.off())

# relative normalized humpbacks, statewide scenarios only, as boxplots
plot_hump_rel_risk_prepost_statewide_bp <- ggplot(
  data = statewide_annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
  ...
  geom_point(position=position_dodge(width=0.5), alpha=0.6)+
  xlab("Scenario") +
  ylab("Relative risk reduction to humpback whales\n(normalized)") +
  #ylim(0,0.4) +
  scale_colour_viridis_d(option="cividis", begin=0.2, end=0.8, direction = -1) +
  scale_x_discrete(labels = wrap_format(30)) + 
  coord_flip() +
...
png(paste0(path_figures, "/plot_hump_rel_risk_prepost_statewide_bp.png"), width = 14, height = 10, units = "in", res = 300)
plot_hump_rel_risk_prepost_statewide_bp
invisible(dev.off())

# relative normalized humpbacks, statewide scenarios only, as geom_line
plot_hump_rel_risk_prepost_statewide_connect <- ggplot(
  data = statewide_annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = relative_hump_risk_n,
...
png(paste0(path_figures, "/plot_hump_rel_risk_prepost_statewide_connect.png"), width = 14, height = 10, units = "in", res = 300)
plot_hump_rel_risk_prepost_statewide_connect
invisible(dev.off())
...
png(paste0(path_figures, "/plot_blue_risk_prepost_statewide_bp.png"), width = 14, height = 10, units = "in", res = 300)
plot_blue_risk_prepost_statewide_bp
invisible(dev.off())

#normalized relative blues, statewide scenarios only, boxplot
plot_blue_rel_risk_prepost_statewide_bp <- ggplot(
  data = statewide_annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
  ...
  geom_point(position=position_dodge(width=0.5), alpha=0.6)+
  xlab("Scenario") +
  ylab("Relative risk reduction to blue whales\n(normalized)") +
  #ylim(0,0.4) +
  scale_colour_viridis_d(option="cividis", begin=0.2, end=0.8, direction = -1) +
  scale_x_discrete(labels = wrap_format(30)) + 
  coord_flip() +
...
png(paste0(path_figures, "/plot_blue_rel_risk_prepost_statewide_bp.png"), width = 14, height = 10, units = "in", res = 300)
plot_blue_rel_risk_prepost_statewide_bp
invisible(dev.off())

# normalized blues, statewide scenarios only, as geom_line
plot_blue_risk_prepost_statewide_connect <- ggplot(
  data = statewide_annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = n_risk_blue,
...
png(paste0(path_figures, "/plot_blue_risk_prepost_statewide_connect.png"), width = 14, height = 10, units = "in", res = 300)
plot_blue_risk_prepost_statewide_connect
invisible(dev.off())

# relative normalized blues, statewide scenarios only, as geom_line
plot_blue_rel_risk_prepost_statewide_connect <- ggplot(
  data = statewide_annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = relative_blwh_risk_n,
...
png(paste0(path_figures, "/plot_blue_rel_risk_prepost_statewide_connect.png"), width = 14, height = 10, units = "in", res = 300) 
plot_blue_rel_risk_prepost_statewide_connect
invisible(dev.off())


### cen CA scenarios
# normalized humpbacks, cenCA only
plot_hump_risk_prepost_cenca <- ggplot(
...
png(paste0(path_figures, "/plot_hump_risk_prepost_cenca.png"), width = 14, height = 10, units = "in", res = 300)
plot_hump_risk_prepost_cenca
invisible(dev.off())

# normalized humpbacks, cenCA scenarios only, boxplot
plot_hump_risk_prepost_cenca_bp <- ggplot(
...
png(paste0(path_figures, "/plot_hump_risk_prepost_cenca_bp.png"), width = 14, height = 10, units = "in", res = 300)
plot_hump_risk_prepost_cenca_bp
invisible(dev.off())

#normalized blues, cenCA scenarios only
plot_blue_risk_prepost_cenca_bp <- ggplot(
  data = cenca_annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = n_risk_blue,
...
png(paste0(path_figures, "/plot_blue_risk_prepost_cenca_bp.png"), width = 14, height = 10, units = "in", res = 300)
...
plot_hump_risk_prepost_bp <- ggplot(
  data = annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = n_risk_humpback,
...
png(paste0(path_figures, "/plot_hump_risk_prepost_bp.png"), width = 14, height = 10, units = "in", res = 300)
plot_hump_risk_prepost_bp
invisible(dev.off())

#normalized blues
plot_blue_risk_prepost_bp <- ggplot(
  data = annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = n_risk_blue,
...
png(paste0(path_figures, "/plot_blue_risk_prepost_bp.png"), width = 14, height = 10, units = "in", res = 300)
plot_blue_risk_prepost_bp
invisible(dev.off())
...
scale_compare <- annual_statewide_df_focal_scenarios %>%
...
write_rds(scale_compare, paste0(path_rds,"/scale_compare_all_vessels.rds"))
...
# can start here to make scale_compare plots
scale_compare <- read_rds(paste0(path_rds,"/scale_compare_all_vessels.rds"))
...
png(paste0(path_figures, "/plot_hump_risk_scale_compare.png"), width = 14, height = 10, units = "in", res = 300)
plot_hump_risk_scale_compare
invisible(dev.off())

plot_hump_risk_statewide <- ggplot(
  data = scale_compare %>% filter(scale != "Central California Only"),
  aes(
    x = scale,
    y = mean_relative_hump_risk_n,
    colour = scenario_type,
...
plot_hump_risk_statewide

png(paste0(path_figures, "/plot_hump_risk_statewide.png"), width = 14, height = 10, units = "in", res = 300)
plot_hump_risk_statewide
invisible(dev.off())
...
png(paste0(path_figures, "/plot_blwh_risk_scale_compare.png"), width = 14, height = 10, units = "in", res = 300)
plot_blwh_risk_scale_compare
invisible(dev.off())

plot_blwh_risk_statewide <- ggplot(
  data = scale_compare %>% filter(scale != "Central California Only"),
  aes(
    x = scale,
    y = mean_relative_blwh_risk_n,
...
png(paste0(path_figures, "/plot_blwh_risk_statewide.png"), width = 14, height = 10, units = "in", res = 300)
plot_blwh_risk_statewide
invisible(dev.off())
...
## Avg risk in 2009-13 v 2014-19 for blues and humps by scenario. Small vessels
...
annual_statewide_df_focal_scenarios_small_vessels %<>% mutate(
  plotting_year = as.numeric(substr(crab_year,6,9)),
  pre_post = ifelse(plotting_year >=2015, "2014-2019","2009-2014")
) 
glimpse(annual_statewide_df_focal_scenarios_small_vessels)
...
df_tradeoff_focal_scenarios_small_vessels$pretty_scenario_names <- c(
    ...
    rep("Early Closure Statewide", length(unique(df_tradeoff_focal_scenarios_small_vessels$crab_year))),
    rep("Delay Statewide, Early Closure Statewide", length(unique(df_tradeoff_focal_scenarios_small_vessels$crab_year))),
    rep("Delay CenCA, Early Closure Statewide", length(unique(df_tradeoff_focal_scenarios_small_vessels$crab_year))),
...
# consider mean_relative_hump_risk_n, which is the expected reduction in risk relative to sq for each scenario. set up for geom_boxplot
annual_statewide_df_focal_scenarios_means_small_vessels <- annual_statewide_df_focal_scenarios_small_vessels %>% 
  group_by(number_id, scenario_df_name, pretty_scenario_names, pre_post) %>%
  summarise(
    mean_relative_hump_risk_n = mean(relative_hump_risk_n),
    mean_relative_blwh_risk_n = mean(relative_blwh_risk_n),
    mean_relative_both_risk_n = mean(relative_both_risk_n),
  ...
  mutate(scenario_rank = row_number())
glimpse(annual_statewide_df_focal_scenarios_means_small_vessels)

annual_statewide_df_focal_scenarios_means_bp_small_vessels <- annual_statewide_df_focal_scenarios_small_vessels %>% 
  left_join(annual_statewide_df_focal_scenarios_means_small_vessels) %>%
  mutate(
    scenario_label = if_else(plotting_year == min(plotting_year), as.character(pretty_scenario_names), NA_character_)
  ) %>%
  arrange(
    scenario_rank
  )
#View(annual_statewide_df_focal_scenarios_means_bp)

# normalized humpbacks
plot_hump_risk_prepost_small_vessels <- ggplot(
  data = annual_statewide_df_focal_scenarios_means_bp_small_vessels,
  aes(
    x = reorder(pretty_scenario_names,scenario_rank),
    y = n_risk_humpback,
    colour = factor(pre_post)
...
png(paste0(path_figures, "/plot_hump_risk_prepost_small_vessels.png"), width = 14, height = 10, units = "in", res = 300)
plot_hump_risk_prepost_small_vessels
invisible(dev.off())

# normalized blues
plot_blue_risk_prepost_small_vessels <- ggplot(
  data = annual_statewide_df_focal_scenarios_means_bp_small_vessels,
  aes(
    x = reorder(pretty_scenario_names,scenario_rank),
    y = n_risk_blue,
...
png(paste0(path_figures, "/plot_blue_risk_prepost_small_vessels.png"), width = 14, height = 10, units = "in", res = 300)
plot_blue_risk_prepost_small_vessels
invisible(dev.off())
...
png(paste0(path_figures, "/plot_DCRB_rev_prepost_statewide_bp.png"), width = 14, height = 10, units = "in", res = 300)
plot_DCRB_rev_prepost_statewide_bp
invisible(dev.off())

# DCRB revenue, statewide scenarios only, as geom_line
plot_DCRB_rev_prepost_statewide_connect <- ggplot(
  data = statewide_annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = DCRB_rev/(10^5),
...
png(paste0(path_figures, "/plot_DCRB_rev_prepost_statewide_connect.png"), width = 14, height = 10, units = "in", res = 300)
plot_DCRB_rev_prepost_statewide_connect
invisible(dev.off())

# relative DCRB $, statewide scenarios only, as boxplots
plot_DCRB_rel_rev_prepost_statewide_bp <- ggplot(
  data = statewide_annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = relative_dollars,
...
png(paste0(path_figures, "/plot_DCRB_rel_rev_prepost_statewide_bp.png"), width = 14, height = 10, units = "in", res = 300)
plot_DCRB_rel_rev_prepost_statewide_bp
invisible(dev.off())

# relative DCRB $, statewide scenarios only, as geom_line
plot_DCRB_rel_rev_prepost_statewide_connect <- ggplot(
  data = statewide_annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = relative_dollars,
...
png(paste0(path_figures, "/plot_DCRB_rel_rev_prepost_statewide_connect.png"), width = 14, height = 10, units = "in", res = 300)
plot_DCRB_rel_rev_prepost_statewide_connect
invisible(dev.off())

# DCRB landings, statewide scenarios only, as boxplots
plot_DCRB_lbs_prepost_statewide_bp <- ggplot(
  data = statewide_annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = DCRB_lbs/(10^5),
...
png(paste0(path_figures, "/plot_DCRB_lbs_prepost_statewide_bp.png"), width = 14, height = 10, units = "in", res = 300)
plot_DCRB_lbs_prepost_statewide_bp
invisible(dev.off())

# DCRB landings, statewide scenarios only, as geom_line
plot_DCRB_lbs_prepost_statewide_connect <- ggplot(
  data = statewide_annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = DCRB_lbs/(10^5),
...
png(paste0(path_figures, "/plot_DCRB_lbs_prepost_statewide_connect.png"), width = 14, height = 10, units = "in", res = 300)
plot_DCRB_lbs_prepost_statewide_connect
invisible(dev.off())

# relative DCRB landings, statewide scenarios only, as boxplots
plot_DCRB_rel_lbs_prepost_statewide_bp <- ggplot(
  data = statewide_annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = relative_pounds,
...
png(paste0(path_figures, "/plot_DCRB_rel_lbs_prepost_statewide_bp.png"), width = 14, height = 10, units = "in", res = 300)
plot_DCRB_rel_lbs_prepost_statewide_bp
invisible(dev.off())

# relative DCRB landings, statewide scenarios only, as geom_line
plot_DRCB_rel_lbs_prepost_statewide_connect <- ggplot(
  data = statewide_annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = relative_pounds,
...
png(paste0(path_figures, "/plot_DRCB_rel_lbs_prepost_statewide_connect.png"), width = 14, height = 10, units = "in", res = 300)
plot_DRCB_rel_lbs_prepost_statewide_connect
invisible(dev.off())
...
png(paste0(path_figures, "/all_statewide_connect.png"), width = 18, height = 12, units = "in", res = 300)
ggarrange(
  plot_blue_rel_risk_prepost_statewide_connect,
  plot_DCRB_rel_rev_prepost_statewide_connect,
  plot_hump_rel_risk_prepost_statewide_connect,
...
plot_DCRB_rev_prepost_cenca_bp <- ggplot(
  data = cenca_annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = DCRB_rev/(10^5),
...
png(paste0(path_figures, "/plot_DCRB_rev_prepost_cenca_bp.png"), width = 14, height = 10, units = "in", res = 300)
plot_DCRB_rev_prepost_cenca_bp
invisible(dev.off())

# DCRB lbs, cenCA scenarios only, boxplot
plot_DCRB_lbs_prepost_cenca_bp <- ggplot(
  data = cenca_annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = DCRB_lbs/(10^5),
...
png(paste0(path_figures, "/plot_DCRB_lbs_prepost_cenca_bp.png"), width = 14, height = 10, units = "in", res = 300)
plot_DCRB_lbs_prepost_cenca_bp
invisible(dev.off())


#DCRB $, all scenarios
plot_DCRB_rev_prepost_bp <- ggplot(
  data = annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = DCRB_rev/(10^5),
...
png(paste0(path_figures, "/plot_DCRB_rev_prepost_bp.png"), width = 14, height = 10, units = "in", res = 300)
plot_DCRB_rev_prepost_bp
invisible(dev.off())

#DCRB lbs, all scenarios
plot_DCRB_lbs_prepost_bp <- ggplot(
  data = annual_rank_bp,
  aes(
    x = reorder(pretty_scenario_names,-scenario_rank),
    y = DCRB_lbs/(10^5),
...
png(paste0(path_figures, "/plot_DCRB_lbs_prepost_bp.png"), width = 14, height = 10, units = "in", res = 300)
plot_DCRB_lbs_prepost_bp
invisible(dev.off())

### This is Figure 3 in Samhouri et al
png(paste0(path_figures, "/p_statewide.png"), width = 14, height = 10, units = "in", res = 300)
ggarrange(plot_blue_risk_prepost_statewide_bp,
             plot_DCRB_rev_prepost_statewide_bp,
             plot_hump_risk_prepost_statewide_bp, 
             nrow = 2,
          ncol=2,
...
png(paste0(path_figures, "/p_cenca.png"), width = 14, height = 10, units = "in", res = 300)
# grid.arrange(plot_hump_risk_prepost_cenca_bp,
#              plot_DCRB_rev_prepost_cenca_bp,
#              plot_blue_risk_prepost_cenca_bp, 
#              nrow = 2)
ggarrange(plot_blue_risk_prepost_cenca_bp,
             plot_DCRB_rev_prepost_cenca_bp,
             plot_hump_risk_prepost_cenca_bp, 
             nrow = 2,
              ncol=2,
...
png(paste0(path_figures, "/plot_DCRB_rev_scale_compare.png"), width = 14, height = 10, units = "in", res = 300)
plot_DCRB_rev_scale_compare
invisible(dev.off())

### This is Figure 4 in Samhouri et al
png(paste0(path_figures, "/p_scale_compare.png"), width = 14, height = 10, units = "in", res = 300)
...
## Avg $ in 2009-13 v 2014-19 for small DCRB vessels by scenario.


```{r}

# DCRB revenue
plot_DCRB_rev_prepost_small_vessels <- ggplot(
  data = annual_statewide_df_focal_scenarios_means_bp_small_vessels,
  aes(
    x = reorder(pretty_scenario_names,scenario_rank),
    y = DCRB_rev/10^5,
  ...
  #                    breaks = c(-25,0,25,50,75,100)) +
  xlab("Scenario") +
  ylab(bquote("Dungeness crab fishery revenue\nsmall vessels only\n($, x"*10^5*")")) +
  #bquote(Vc[max](mu~mol ~CO[2]~ m^-2~s^-1)))
  scale_colour_viridis_d(option="cividis", begin=0.2, end=0.8, direction = -1) +
  scale_x_discrete(labels = wrap_format(30)) + 
  theme_classic() +
...
png(paste0(path_figures, "/plot_DCRB_rev__small_vessels_prepost.png"), width = 14, height = 10, units = "in", res = 300)
plot_DCRB_rev_prepost_small_vessels
invisible(dev.off())
...
## Tradeoff plots for early and late time period separately for hump, blues, both. Full time period, 2009-14, 2014-18, 2018-2019. All DCRB vessels.
...
png(paste0(path_figures, "/Tradeoff plot - normalized humpbacks only by pre_post _",today(),".png"), 
    width = 10, height = 8, units = "in", res = 300)
to_hump_n_pre_post
invisible(dev.off())
...
png(paste0(path_figures,"/Tradeoff plot - normalized blues only by pre_post_",today(),".png"), 
    width = 10, height = 8, units = "in", res = 300)
to_blue_n_pre_post
invisible(dev.off())

# what is % change in risk/rev by period and scenario
kable(df_tradeoff_focal_scenarios %>% group_by(pre_post, pretty_scenario_names) %>% summarise(mean_hump = mean(relative_hump_risk_n),
         mean_blwh = mean(relative_blwh_risk_n),                                                 mean_rev = mean(relative_dollars)
         ) %>%
       arrange(pretty_scenario_names, pre_post)
     )

kable(df_tradeoff_focal_scenarios %>% group_by(pre_post, pretty_scenario_names) %>% summarise(median_hump = median(relative_hump_risk_n),
...
plot_hump_risk_prepost_compare <- ggplot(
  data = df_tradeoff_focal_scenarios,
  aes(
    x = pre_post,
    y = relative_hump_risk_n,
    group=pretty_scenario_names,
...
png(paste0(path_figures,"/Tradeoff plot - normalized humpbacks and blues by pre_post_",today(),".png"), 
    width = 10, height = 8, units = "in", res = 300)
to_both_n_pre_post
invisible(dev.off())
...
png(paste0(path_figures,"/Tradeoff plot - normalized blues, normalized humpbacks by pre_post_",today(),".png"), 
...
## Tradeoff plots for early and late time period separately for hump, blues, both. Full time period, 2009-13, 2014-19. Small DCRB vessels.
...
### normalized humpbacks, by pre_post
to_hump_n_pre_post_small_vessels <- ggplot(
  ...
  scale_colour_viridis_d(option="inferno", begin=0.2, end=0.8, direction = -1) +
  ylab("Relative reduction in risk to humpbacks\n(normalized)") +
  xlab("Relative revenue to small Dungeness crab fishing vessels") +
  ylim(-26,100) +
  guides(colour = guide_legend("Scenario")) + #,  shape = guide_legend("Scenario")) +
  theme_classic() +
  theme(
...
png(paste0(path_figures, "/Tradeoff plot small vessels- normalized humpbacks only by pre_post _",today(),".png"), 
    width = 10, height = 8, units = "in", res = 300)
to_hump_n_pre_post_small_vessels
invisible(dev.off())

### normalized blues, by pre_post

to_blue_n_pre_post_small_vessels <- ggplot(
  df_tradeoff_focal_scenarios_small_vessels, #df
  aes(
    x=relative_dollars,
    y=relative_blwh_risk_n,
...
png(paste0(path_figures,"/Tradeoff plot small vessels - normalized blues only by pre_post_",today(),".png"), 
    width = 10, height = 8, units = "in", res = 300)
to_blue_n_pre_post_small_vessels
invisible(dev.off())

### normalized both, by pre_post

to_both_n_pre_post_small_vessels <- ggplot(
  df_tradeoff_focal_scenarios_small_vessels, #df
  aes(
    x=relative_dollars,
    y=relative_both_risk_n,
...
png(paste0(path_figures,"/Tradeoff plot small vessels - normalized humpbacks and blues by pre_post_",today(),".png"), 
    width = 10, height = 8, units = "in", res = 300)
to_both_n_pre_post_small_vessels
invisible(dev.off())
