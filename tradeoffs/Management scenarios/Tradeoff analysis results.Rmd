...
sq_bbox <- st_bbox(sq_maps_grd %>% 
                      st_as_sf()
)

# plot median humpback densities 

# STOPPED HERE. NOT QUITE WORKING. NEED TO ZOOM INTO CA (USE IS.NA(PINGS)==FALSE? AND NEED TO FIX THE GREY PREDICTIONS OF HUMP DENSITIES)
