...
scale_compare_small <- annual_statewide_df_focal_scenarios_small_vessels %>%
...
glimpse(scale_compare_small)
write_rds(scale_compare_small, paste0(path_rds,"/scale_compare_sm_vessels.rds"))
