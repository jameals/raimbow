...
```{r late}
x.late <- mng_risk_sum(x, x.orig, c(11, 12, 1:4), wa.flag = wa.inc)
...
```{r late2}
x.late <- mng_risk_sum(x, x.orig, c(11, 12, 1:3), wa.flag = wa.inc)
...
```{r early1}
x.early1 <- mng_risk_sum(x, x.orig, c(12, 1:10), wa.flag = wa.inc)
...
```{r early2}
x.early2 <- mng_risk_sum(x, x.orig, c(1:10), wa.flag = wa.inc)
