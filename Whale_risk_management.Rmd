...
mng_plot_diff(
  ...
  x.xlab = "Fishing season start year", 
  x.ylab = "Risk (whales*VMS pings / km2)"
)
...
mng_plot_bar(
  x.late, x.orig, risk_dens_season, 
  "Summed risk (density) - closing DC fishery April 1", 
  "Risk (whlaes*VMS pings / km2)"
)
...
mng_plot_bar(
  x.late, x.orig, risk_total_season, 
  "Summed risk (total) - closing DC fishery April 1", 
  "Risk (whlaes*VMS pings)"
)
