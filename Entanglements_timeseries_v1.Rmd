...
Now we load the time series data, and plot histograms of the risk time series values (monthly densities) by region.
...
Next we determine the number of entanglements reported in each year-month, i.e. the corresponding risk value for each entanglement. Then we can make the same plots, but color-coded to indicate how many entanglement reports occurred during that year-month.
