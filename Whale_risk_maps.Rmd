...
Now load humpback abundance, number of VMS pings, and risk values. Make these `sf` objects (`h.sf`, `f.sf`, and `r.sf`, respectively) by joining them with Blake's 5km grid, and convert the values to densities. Then we can examine the distribution of the values across all years and months.
...
grid.area <- fish.all$area_km_lno
