...
#2010-2011 season -- last season with full 100% logbook entry - 13mins to run with full permit data 
...
logs_all_raw <- list.files(path = "E:/Leena/Documents/Projects/raimbow/wdfw/data/OR/seasons with permit info",     
...
# There are 81 instances when 2010-2011 season is included

logs_NA <- logs_all %>% 
  filter(is.na(PermitNumber)|is.na(Potlimit))
#2013-2018:
# All instances of NAs are for vessel ID 549931
...
#2010-2011: more cases but same story, the Set Date is a few days than the Begin Date of permit in permit data table
...
#2020-2011, 2013-2018
#for now just input correct PotLimit values
...
write_csv(logs_all_permits,here::here('wdfw', 'data', 'OR', "ODFW-Dcrab-logbooks-compiled_stackcoords_license_2010-2011_and_2013-2018_20210825.csv"))
```
