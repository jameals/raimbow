...
##################
#logbook yers when 100% logs entered
...
#error because 2009-2010 season vessel number column has all numbers (double) while in other seasons it is character
...
write_csv(logs_all_permits,here::here('wdfw', 'data', 'OR', "ODFW-Dcrab-logbooks-compiled_stackcoords_license_2007-2011_and_2013-2018_20210827.csv"))
```
