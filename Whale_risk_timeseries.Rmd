...
if (user == "JS") {
  ...
  path.plots <- "../raimbow-local/Plots/Whale_risk_timeseries_noWA/"
...
p1 <- raimbow_ggplot(
  ...
  y.lab = "Whales * VMS pings", wa.flag = FALSE
)
p2 <- raimbow_ggplot(
...
p1 <- raimbow_ggplot(
  ...
  y.lab = "Monthly ratio relative to 2009-13", wa.flag = FALSE
)
p2 <- raimbow_ggplot(
...
p1 <- raimbow_ggplot(
  ...
  y.lab = "Monthly anomaly relative to 2009-13", wa.flag = FALSE
)
p2 <- raimbow_ggplot(
...
p1 <- raimbow_ggplot(
  ...
  y.lab = "Std dev from 2009-13 mean", wa.flag = FALSE
)
p2 <- raimbow_ggplot(
